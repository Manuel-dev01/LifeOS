...
export default function AskView({ onOpenGraph, messages, setMessages, loading, setLoading }) {
  ...
  return (
    <div className="h-full flex flex-col">
      <header className="flex items-center justify-between px-4 md:px-8 py-4 md:py-5 border-b border-[#e2e4ea]">
        <div>
          <h1 className="text-[18px] md:text-[20px] font-semibold">Ask LifeOS</h1>
      ...
      <div className="flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-[1fr_320px]">
        ...
        <div className="flex flex-col min-h-0 lg:border-r border-[#e2e4ea]">
        ...
        {/* recall rail — desktop only */}
        <div className="hidden lg:block p-4 bg-ink-side">
